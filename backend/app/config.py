...
# Alpaca credentials must be supplied by the environment or backend/.env.
# Never retain a deployable key in source control.
ALPACA_API_KEY = os.getenv("ALPACA_API_KEY", "")
ALPACA_SECRET_KEY = os.getenv("ALPACA_SECRET_KEY") or os.getenv("ALPACA_API_SECRET") or ""
...
EXCLUDED_TICKERS = {"MSFT", "META", "AMD", "MU", "MSTR"}  # Current non-crypto trading scope
DEFAULT_WATCHLIST = ["SNDK", "TSLA", "PLTR", "NVDA"]
