# backend/data/run_weekly_market_replay_ai_optimized.py
"""
AI-Optimized Weekly Market Replay Engine:
Includes Dynamic Position Scale-Down on Drawdowns & Stage-1 Chop Regime Safeguard.
Prevents large single-day drawdowns on high-whip days (e.g. 2026-08-31).
"""
...
def replay_entire_week_ai_optimized():
    ...
    print("================================================================================")
    print("🤖 AI OPTIMIZED PAST 5 TRADING DAYS (LAST WEEK) MARKET REPLAY")
    print("================================================================================")
    ...
    for target_date in last_5_dates:
        ...
        # AI Adaptive Risk Circuit: Dynamic position multiplier starts at 1.0
        pos_scale_mult = 1.0
        ...
        for symbol, df in stock_dfs.items():
            ...
            for i in range(5, len(df_session)):
                ...
                if is_trap and "Bull Trap" in trap_reason:
                    ...
                    target_w = 1.0
                elif composite_alpha >= 22.0 or (micro_vel_3 >= 0.18 and close > vwap):
                    target_w = 1.0
                elif composite_alpha <= -22.0 or (micro_vel_3 <= -0.18 and close < vwap):
                    target_w = -1.0
                ...
                if target_w != w_t:
                    if w_t != 0.0:
                        ...
                        if trade_pnl > 0:
                            ...
                            if consecutive_losses >= 2:
                                # AI Dynamic Risk Modulation: Scale down on whipsaws
                                pos_scale_mult = max(0.25, pos_scale_mult * 0.5)

                    if target_w != 0.0:
                        w_t = target_w
                        entry_price = close
                        target_notional = real_buying_power * 0.45 * pos_scale_mult
                    ...
                    if w_t != 0.0:
                        ...
                        if pnl_pct <= -0.010: # 1.0% AI Tight Risk Stop
                            trade_pnl = entry_shares * (close - entry_price) if w_t > 0 else entry_shares * (entry_price - close)
                            day_pnl += trade_pnl
                            day_trades += 1
                            consecutive_losses += 1
    ...
    print("\n================================================================================")
    print("🏆 AI OPTIMIZED PAST 5 TRADING DAYS (LAST WEEK) CUMULATIVE REPLAY SUMMARY")
    print("================================================================================")
...
if __name__ == "__main__":
    replay_entire_week_ai_optimized()
