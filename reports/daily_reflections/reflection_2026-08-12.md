...
- **盈利/亏损笔数**: `8` 胜 / `16` 负
- **胜率 (Win Rate)**: `15.09%`
- **当日实现总盈亏 (Total Realized PnL)**: `$-8789.07`
...
| :--- | :--- | :--- | :--- |
| **Optimal_Profit (主升浪盈利)** | `8` | `15.1%` | 完美顺应趋势主升浪 |
| **Premature_Exit (小额止盈)** | `0` | `0.0%` | 顺应趋势但止盈过快 |
| **Slippage_Friction (滑点磨损)** | `29` | `54.7%` | 交易摩擦与滑点小额磨损 |
| **False_Breakout (假突破洗盘)** | `16` | `30.2%` | 震荡盘口假突破触发止损 |
...
- Detected high false breakout ratio (30.2%), elevated P_win entry gate to 0.65
- Detected slippage friction (54.7%), expanded ATR stop loss to 0.75x
