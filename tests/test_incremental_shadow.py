...
spec=importlib.util.spec_from_file_location('incremental_shadow',ROOT/'scripts/shadow_incremental_policy.py')
...
def test_paper_adapter_records_conditional_horizon_without_assuming_fills(tmp_path,monkeypatch):
    ...
    manifest=dict(registered_at='2026-08-30T21:00Z',specification=dict(candidate='incremental_all',input_symbols=list(frames),
    ...
    assert r['explanation']['horizon_bars']==1
